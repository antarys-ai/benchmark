...
export const data = {
  "metadata": {
    "generated_at": "2025-07-20T13:58:35.533600",
    "databases": [
      "Chroma",
      "Antarys",
      "Pinecone",
  ...
  "write_performance": {
    ...
    "Pinecone": {
      "throughput_vectors_per_sec": 2507.3857153924264,
      "avg_batch_time": 0.039882176637649536,
      "batch_size": 100,
      "total_points": 100000,
      "percentiles": {
        "p50": 0.03874051570892334,
        "p90": 0.04361138343811035,
        "p99": 0.05996307611465453
      },
      "successful_batches": 1000
    },
    "Qdrant": {
  ...
  "read_performance": {
    ...
    "Pinecone": {
      "queries_10": {
        "throughput_queries_per_sec": 1.5262861722527457,
        "avg_query_time": 0.6551851272583008,
        "successful_queries": 10,
        "percentiles": {
          "p50": 0.7362146377563477,
          "p90": 0.789582085609436,
          "p99": 0.8906959366798402
        }
      },
      "queries_100": {
        "throughput_queries_per_sec": 1.6562846523852268,
        "avg_query_time": 0.6037609529013586,
        "successful_queries": 99,
        "percentiles": {
          "p50": 0.4956998825073242,
          "p90": 0.7493731021881104,
          "p99": 1.0023149919509888
        }
      },
      "queries_1000": {
        "throughput_queries_per_sec": 1.7090531435419098,
        "avg_query_time": 0.5851193122804597,
        "successful_queries": 967,
        "percentiles": {
          "p50": 0.5114729404449463,
          "p90": 0.7340078353881836,
          "p99": 0.8616397953033448
        }
      }
    },
    "Qdrant": {
  ...
  "charts": {
    ...
    "read_throughput": [
      ...
      {
        "database": "Pinecone",
        "throughput": 1.7090531435419098,
        "avg_latency": 585.1193122804597
      },
      {
        "database": "Qdrant",
    ...
    "latency_comparison": [
      ...
      {
        "database": "Pinecone",
        "p50": 511.4729404449463,
        "p90": 734.0078353881836,
        "p99": 861.6397953033447
      },
      {
        "database": "Qdrant",
    ...
    "percentile_comparison": [
      ...
      },
      {
        "database": "Pinecone",
        "operation": "write",
        "p50": 38.74051570892334,
        "p90": 43.61138343811035,
        "p99": 59.963076114654534
      },
      {
        "database": "Qdrant",
        "operation": "write",
  ...
  "summary": {
    "total_databases": 5,
    "write_stats": {
      "max_throughput": 2507.3857153924264,
      "min_throughput": 743.15885654519,
      "avg_throughput": 1929.1114277093418,
      "median_throughput": 2213.834400172162,
      "std_dev": 690.5862820430417
    },
    "read_stats": {
      "max_throughput": 75.7091824322229,
      "min_throughput": 1.7090531435419098,
      "avg_throughput": 25.55843728831032,
      "median_throughput": 14.47612159066315,
      "std_dev": 29.49246183281645
    },
    "recall_stats": {
      "max_recall": 1.0,
      "min_recall": 0.9996,
      "avg_recall": 0.99992,
      "median_recall": 1.0,
      "std_dev": 0.00017888543819996348
    }
  }
} as const;

export type DatabaseName = "Chroma" | "Antarys" | "Pinecone" | "Qdrant" | "Milvus";
